//
//  ViewController.m
//  XLPushSmaller&PullBigger-Demo
//
//  Created by Mac-Qke on 2019/1/14.
...
- (instancetype)initWithFrame:(CGRect)frame backgroundView:(NSString *)name headView:(NSString *)headImgName headViewWidth:(CGFloat)width signLabel:(NSString *)signature {
    if (self = [super initWithFrame:frame]) {
        ...
        UILabel *signLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(headView.frame), self.bounds.size.width, 40)];
...
@property (nonatomic, weak) HeadView *myView;
@end
...
- (void)initUI {
    ...
    UITableView *myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, navHeight, VCWidth, VCHeight)];
    ...
    HeadView *vc = [[HeadView alloc]initWithFrame:headRect backgroundView:@"background.jpg" headView:@"headImg.jpg" headViewWidth:(CGFloat)(VCWidth/4) signLabel:@"Crazy Dragon"];
